...
var jumpSound, dieSoud, milestoneSound
...
function setup() {
  ...
  ground = createSprite(width/2,height-60,width+200,50);
...
function spawnObstacles(){
 if (frameCount % 60 === 0){
   var obstacle = createSprite(width+10,height-70,10,40);
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
     cloud = createSprite(width+10,height-300,40,10);
